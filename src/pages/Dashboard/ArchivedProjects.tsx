...
const ALLOWED_ROLES = ["SUPER_ADMIN", "ADMIN", "PROJECT_MANAGER", "FINANCE"];
        ...
        <div className="mt-8 space-y-3">
          ...
          <div className="max-w-xl mx-auto mt-16 p-8 text-center border border-dashed border-gray-200 rounded-xl">
            ...
            <p className="text-sm text-gray-500 mt-1">
              You don't have permission to view archived projects.
            </p>
          </div>
        </div>
      </CommonWrapper>
          ...
          <div className="flex items-center justify-between gap-4 flex-wrap">
            <div>
              ...
              <p className="text-sm text-gray-500">
                Manage projects that have been moved to the archive.
              </p>
            </div>
                      ...
                      >
                        ...
                        <TableCell className="text-right">
                          <div className="flex justify-end gap-2">
                            {/* Archiving hides a project from the studio list,
                                but admins and finance still need to read what
                                was on it. */}
                            <Button
                              variant="outline"
                              size="sm"
        ...
        <DialogContent className="bg-white">
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              <strong>{projectToDelete?.projectName}</strong>. This action cannot
              be undone. All related data will be lost.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="my-6 space-y-4">
            <p className="text-sm text-gray-600">
              Please type{" "}
              <span className="font-bold text-red-600 px-1.5 py-0.5 bg-red-50 rounded border border-red-100 italic">
                Delete
              </span>{" "}
              below to confirm.
            </p>
