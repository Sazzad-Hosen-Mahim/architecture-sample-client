...
const MediaCopyright = lazy(() => import("@/pages/MediaCopyright"));
...
const routes = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: "new-inquiries-list",
        element: (
          <SuspenseWrapper>
            <NewInquiriesListPage />
          </SuspenseWrapper>
        ),
      },
      {
