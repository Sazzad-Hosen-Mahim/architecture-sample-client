  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[1100px] bg-white text-black p-0 overflow-hidden">
        <div id="timesheet-modal-content">
          ...
          <div className="px-6 py-4 bg-white border-t border-gray-100 flex justify-between items-center no-pdf" data-html2canvas-ignore="true">
            <div className="flex gap-2">
              ...
              <Button
                ...
                className="font-bold flex items-center gap-2 disabled:opacity-60 disabled:cursor-not-allowed"
              >
